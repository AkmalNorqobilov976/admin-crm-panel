...
<template>
  <svg width="24" height="24" viewBox="0 0 24 24" :fill="bgColor" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      stroke="color" stroke-width="1.8" stroke-miterlimit="10" stroke-linecap="round" />
    <path
      d="M13.8699 3.19994C13.5599 3.10994 13.2399 3.03994 12.9099 2.99994C11.9499 2.87994 11.0299 2.94994 10.1699 3.19994C10.4599 2.45994 11.1799 1.93994 12.0199 1.93994C12.8599 1.93994 13.5799 2.45994 13.8699 3.19994Z"
      stroke="color" stroke-width="1.8" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
    <path
      ...
      stroke="color" stroke-width="1.8" stroke-miterlimit="10" />
  </svg>
</template>>